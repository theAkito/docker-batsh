...
ENV HOME=/home/opam
WORKDIR /home/opam
RUN opam init --bare -a --disable-sandboxing
RUN eval $(opam env)
RUN opam switch create 4.02.0 ocaml-base-compiler.4.02.0
RUN opam switch create 4.02.1 ocaml-base-compiler.4.02.1
RUN opam switch create 4.02.2 ocaml-base-compiler.4.02.2
RUN opam switch create 4.02.3 ocaml-base-compiler.4.02.3
RUN eval $(opam env)                                                     
